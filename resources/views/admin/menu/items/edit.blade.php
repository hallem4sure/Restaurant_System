        ...
        <div class="card-body row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('subcategory_id') is-invalid @enderror" id="subcategory_id" name="subcategory_id">
                        ...
                        @foreach($subcategories as $subcategory)
                            <option value="{{ $subcategory->id }}" {{ old('subcategory_id', $menuItem->subcategory_id) == $subcategory->id ? 'selected' : '' }}>{{ $subcategory->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="select2-purple">
                        <select class="select2" multiple="multiple" data-placeholder="Select a Tag" data-dropdown-css-class="select2-purple" style="width: 100%;" name="tags[]">
                            @foreach($tags as $tag)
                                <option value="{{ $tag->id }}" {{ (is_array(old('tags', $menuItem->tags->pluck('id')->toArray())) && in_array($tag->id, old('tags', $menuItem->tags->pluck('id')->toArray()))) ? 'selected' : '' }}>{{ $tag->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label for="images">Replace Images (Leaves blank to keep current)</label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', $menuItem->sort_order) }}">
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        ...
                        <input type="checkbox" class="custom-control-input" id="is_available" name="is_available" value="1" {{ old('is_available', $menuItem->is_available) ? 'checked' : '' }}>
